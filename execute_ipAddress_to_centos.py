...
def main():
    ...
    try:
        ...
        cmd_set_ip = "sudo ip addr add 10.14.45.130/24 dev ens192 && sudo ip route add default via 10.14.45.1"
        ...
        # DNS adresini setle
        cmd2 = 'echo "nameserver 1.1.1.1" | sudo tee /etc/resolv.conf > /dev/null'
